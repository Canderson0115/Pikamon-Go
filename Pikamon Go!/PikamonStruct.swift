...
struct PikamonEnemies2
{
        ...
        var Glacierite = Parameters(name: "Glacierite", type: [types.normal], health: 250, alive: true, moveSet: [moves.punch], effects: [""], weight: 0.2)
        
        var Bochtite = Parameters(name: "Bochtite", type: [types.normal], health: 250, alive: true, moveSet: [moves.punch], effects: [""], weight: 0.2)
        
        var Trithyta = Parameters(name: "Trithyta", type: [types.normal], health: 500, alive: true, moveSet: [moves.punch], effects: [""], weight: 0.2)
        
        var Pokéchew = Parameters(name: "Pokéchew", type: [types.normal], health: 250, alive: true, moveSet: [moves.punch], effects: [""], weight: 0.2)
        
        var Firemander = Parameters(name: "Firemander", type: [types.fire], health: 250, alive: true, moveSet: [moves.punch, moves.flameTosser], effects: [""], weight: 0.01)
        
        var Lonelysore = Parameters(name: "Lonelysore", type: [types.normal], health: 250, alive: true, moveSet: [moves.punch], effects: [""], weight: 0.01)
